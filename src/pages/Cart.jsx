  ...
  return (<div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center">
    {
      ...
      (
        <div className="flex justify-between gap-[80px] ">
          ...
          <div className=" p-5 gap-5 my-14 h-full justify-between w-[100%] md:w-[40%] mt-5  flex flex-col">
            ...
            <div className="flex flex-col">
              <p className="text-xl font-bold">
                <span className="text-gray-700 font-semibold">Total Amount :</span>  ${totalAmount}</p>
